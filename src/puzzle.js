        ...
        return (
            <table className="puzzle">
                <tr className="rivi0">
                    ...
                    <td className="ruutu1" style={valiStyle}></td>
                    <td className="ruutu2" style={valiStyle}>6.</td>
                    <td className="ruutu3" style={valiStyle}></td>
                    <td className="ruutu1" style={valiStyle}></td>
                    <td className="ruutu2" style={valiStyle}>3.</td>
                </tr>
                <tr className="rivi1">
                    <td className="ruutu1" style={valiStyle}></td>
                    <td className="ruutu1" style={valiStyle}></td>
                    <td className="ruutu2" style={valiStyle}></td>
                    <td className="ruutu3" style={valiStyle}> 1.</td>
                    <td className="ruutu4" style={ruutuStyle}></td>
                    <td className="ruutu5" style={ruutuStyle}></td>
                    <td className="ruutu6" style={ruutuStyle}></td>
                    <td className="cell cell6" style={ruutuStyle}></td>
                    <td className="cell cell7" style={ruutuStyle}></td>
                </tr>
                <tr className="rivi2">
                    <td className="ruutu1" style={valiStyle}></td>
                    <td className="ruutu1" style={valiStyle}></td>
                    ...
                    <td className="cell cell5" style={ruutuStyle}></td>
                    <td className="ruutu1" style={valiStyle}></td>
                    <td className="ruutu2" style={valiStyle}></td>
                ...
                <tr className="rivi3">
                    <td className="ruutu1" style={valiStyle}></td>
                    <td className="ruutu1" style={valiStyle}>4.</td>
                    <td className="ruutu2" style={valiStyle}></td>
                    <td className="ruutu3" style={valiStyle}></td>
                    <td className="ruutu4" style={valiStyle}> 2.</td>
                    <td className="ruutu4" style={ruutuStyle}></td>
                    <td className="ruutu5" style={ruutuStyle}></td>
                    <td className="ruutu6" style={ruutuStyle}></td>
                    <td className="ruutu4" style={ruutuStyle}></td>
